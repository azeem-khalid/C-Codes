...
class Teacher
{
	...
	public:
		...
		{
			ofstream myfile;
			myfile.open("C:\\Users\\Khalid\\Desktop\\CP Final Project\\Teachers Record.txt");
			string name;
			string id;
			char ch;
			string department;
		...
		void viewTeacherRecords()
		{
			...
			string department;
			ifstream infile2;
			infile2.open("C:\\Users\\Khalid\\Desktop\\CP Final Project\\Teachers Record.txt");
			while(!infile2.eof())
			{
				//string name;
				infile2>>name;
...
class Invigilator: public Teacher
{
	...
	public:
		...
		{
			ofstream myfile;
			myfile.open("C:\\Users\\Khalid\\Desktop\\CP Final Project\\Teachers.txt");
			string teachername;
		...
		void setTeachersDuties()
		{
			...
			ifstream infile2;
			ofstream myfile2;
			myfile2.open("C:\\Users\\Khalid\\Desktop\\CP Final Project\\TeachersDuties.txt");
			infile2.open("C:\\Users\\Khalid\\Desktop\\CP Final Project\\ClassRooms.txt");
			infile.open("C:\\Users\\Khalid\\Desktop\\CP Final Project\\Teachers.txt");
			if(infile.fail())
			{
		...
		void viewTeacherDuties()
		{
			...
			string name;
			int classes;
			myfile3.open("C:\\Users\\Khalid\\Desktop\\CP Final Project\\TeachersDuties.txt");
			while(!myfile3.eof())
			{
				myfile3>>name;
				cout<<name<<endl;
